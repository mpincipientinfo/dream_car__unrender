<template>
  <div>
    ...
    <SectionCredentials
      :sectionCredentialsDataProp="sectionCredentialsDataProp"
    />
...
import SectionCredentials from "./sections/section_credentials";
export default {
  components: {
    SectionHead,
    SectionBenefits,
  ...
  methods: {
    async fetchData() {
      ...
      this.sectionCredentialsDataProp = data.section_referenzen;
    }
  }
};
</script>
